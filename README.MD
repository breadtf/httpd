...
A full list of all options can be found [all.conf](https://github.com/breadtf/httpd/blob/main/server_root/config/all.conf) or [on the W3C HTTPD Website](https://www.w3.org/Daemon/User/Config/Overview.html).
